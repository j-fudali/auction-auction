    ...
    children: [
      {
        ...
        resolve: { products: productsListResolver, userId: userIdResolver },
      },
      {
        path: "products/:id",
        component: ProductViewComponent,
        resolve: { product: productResolver, userId: userIdResolver },
      },
      {
        path: "my-profile",
        loadChildren: () => import("./pages/my-profile/my-profile-routing"),
      ...
      },
      {
        ...
        canActivate: [dashboardGuard],
        resolve: { discussions: discussionsResolver, userId: userIdResolver },
      },
